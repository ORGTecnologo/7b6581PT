...
insert into contenido_tema_musical(album_tema,artista_tema,duracion_tema,id) 
values ('Metropolis Pt. 2: Scenes from a Memory', 'Dream Theater', '08:00',1);
...
insert into contenido_libro(autor , fecha_publicacion , id)
values ('FRANCISCO ARAGÓN MESA' , '2009-10-8' , 2);
insert into contenido_foto(id,url_foto,fk_contenido) 
...
insert into contenido_software (es_trial, id) values (false , 3);
insert into contenido_foto(id,url_foto,fk_contenido) 
...
insert into contenido_video (calidad_video, duracion_video, formato_video, id) 
values ('buena' , '03:32', 'flv', 4);
insert into contenido_foto(id,url_foto,fk_contenido) 
