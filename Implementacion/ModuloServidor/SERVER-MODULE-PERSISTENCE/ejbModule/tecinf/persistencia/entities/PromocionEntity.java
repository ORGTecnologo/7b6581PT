...
@NamedQueries( {
	...
	@NamedQuery(name = "PromocionEntity.findPromocionVigenteAFechaPorContenido", 
		query = "SELECT e FROM PromocionEntity e WHERE e.contenido.id = :idContenido and e.fechaInicioPromocion < :fecha and e.fechaFinPromocion > :fecha") ,
